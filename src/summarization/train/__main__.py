...
def train(model_name):
    ...
    if args.model_version == "small":
        if model_name == 't5':
            ...
            tokenizer = BartTokenizer.from_pretrained("facebook/bart-small", model_max_length=512)
            model = BartForConditionalGeneration.from_pretrained("facebook/bart-small")
